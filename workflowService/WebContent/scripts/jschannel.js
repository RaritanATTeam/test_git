// JQUERY base64 decode/encode libs
        ...
        build: function(cfg) {
            var debug = function(m) {
                if (cfg.debugOutput && window.console && window.console.log) {
                    ...
                    try { if (typeof m !== 'string') m = $.toJSON(m); } catch(e) { }
            ...
            //if (!window.JSON || !window.$.toJSON || ! window.$.secureEvalJSON) {
          ...
          //  }
            ...
            var postMessage = function(msg, force) {
                ...
                if (!force && !ready) {
                    ...
                    cfg.window.postMessage($.toJSON(msg), cfg.origin);
                }
            }
