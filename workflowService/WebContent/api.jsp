...
<%@ page import="com.raritan.at.workflow.service.*" %>
...
if("checkTestCase".equals(action)) {
	...
	//http://localhost:8080/workflowService/api.jsp?action=checkTestCase&task_no=TA531&test_case_no=TC158
	
	service.checkRallyTestCase(testCaseNo,taskNo);
	...
	//http://localhost:8080/workflowService/api.jsp?action=checkTestResult&task_no=TA531&test_case_no=TC158

	service.checkRallyTestResult(testCaseNo,taskNo);
